    ...
    <div className="task-detail">
      ...
      <div className="task-detail-card">
        ...
        <div className="task-detail-actions">
          ...
          {currentUser !== null && currentUser !== task.listerId && task.status === "Available" && (
            <button
              className="btn"
              onClick={() => setShowOfferForm((shown) => !shown)}
            >
        ...
        {showOfferForm && currentUser !== null && task !== null && (
          <div style={{ marginTop: "24px", paddingTop: "24px", borderTopWidth: "1px", borderTopStyle: "solid", borderTopColor: "hsl(30, 25%, 85%)" }}>
            <AddOfferForm
              gigId={task._id}
              onAdded={() => setShowOfferForm(false)}
            />
          </div>
        )}
      </div>
