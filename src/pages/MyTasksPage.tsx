...
export const MyTasksPage = (): JSX.Element => {
  ...
  return (
    <div style={{ paddingTop: "32px", paddingBottom: "32px", paddingLeft: "20px", paddingRight: "20px", maxWidth: "800px", marginTop: "0", marginBottom: "0", marginLeft: "auto", marginRight: "auto" }}>
      <h2 style={{ fontFamily: "sans-serif", fontWeight: 400, fontSize: "24px", marginBottom: "20px" }}>
        My Tasks
      </h2>
      <input
        type="text"
